...
function Hero() {
  return (
   ...
   <div className=' bg-gradient-to-t from-green-100 to-white h-screen w-full md:flex flex-row '>
    <div className='h-screen p-5 md:pl-20 w-full md:w-5/6  flex flex-col items-center justify-center  '>
     <div className=' pt-30 font-mono w-full p-5 flex  text-4xl font-bold  text-green-800'>
      <h1> hii GAMSA!</h1>
     </div>
      <div className='font-mono w-full flex  text-2xl font-bold p-5 text-green-800'>
      <h1> Crafting Digital Magic with Code...</h1>
     </div>
      <div className=' w-full  font-bold text-lg text-green-800 flex justify-center items-center font-serif p-2'>
     ...
     <div className=' m-5 flex gap-4 justify-center items-center text-4xl text-green-200  font-bold'>
   ...
   <FaGithub />
         ...
         <div className= ' bg-gradient-to-t from-green-100 to-white h-screen w-full  md:w-3/6  p-20 flex flex-col gap-4 flex items-center justify-center  '>
         <img src="../src/assets/images/Human.jpg" alt="" className='rounded-full' />
          </div>
